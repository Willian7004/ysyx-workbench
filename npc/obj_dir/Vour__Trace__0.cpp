...
void Vour___024root__trace_chg_0_sub_0(Vour___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vour___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vour___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vour___024root__trace_chg_0_sub_0(Vour___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vour__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vour___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+3,(vlSelf->our__DOT__count),32);
}
